...
export default function PrintReceiptPage() {
  ...
  return (
    <div className="p-6 text-center font-sans">
      <div
        className="bg-black text-green-400 text-3xl font-bold p-6 rounded mb-6"
      >
      ...
      <button
        ...
        onClick={() => window.open(`/receipt/${docNumber}`, "_blank", "width=500,height=600")}
      >
        พิมพ์ใบเสร็จ
      </button>
      <button
        className="bg-blue-500 text-white px-4 py-2 rounded mb-3 w-full"
        onClick={() => window.open(`/receipt-mini/${docNumber}`, "_blank", "width=500,height=600")}
      >
        พิมพ์บิลย่อ
      </button>
      <button
        ...
        onClick={() => {
          window.close(); // ปิด popup นี้
          window.opener?.location.replace("/welcome"); // กลับหน้า welcome บนหน้าหลัก
        }}
      >
        จบรายการ
      </button>
