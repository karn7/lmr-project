...
function detectCurrency(text) {
  ...
  const map = [
    ...
    { code: "KRW", re: /(\bkrw\b|วอน|won|เกาหลี|เกาหลีใต้)/i },
    { code: "GBP", re: /(\bgbp\b|ปอนด์|pound|อังกฤษ|สหราชอาณาจักร)/i },
    { code: "AED", re: /(\baed\b|ดีแรห์ม|dirham|สหรัฐอาหรับเอมิเรตส์|ดูไบ)/i },
    { code: "AUD", re: /(\baud\b|ดอลลาร์ออส|australian|ออสเตรเลีย|ออส)/i },
    { code: "BDT", re: /(\bbdt\b|ตากา|taka|บังกลาเทศ)/i },
    { code: "BHD", re: /(\bbhd\b|ดีนาร์บาห์เรน|bahrain|บาห์เรน)/i },
    { code: "BND", re: /(\bbnd\b|ดอลลาร์บรูไน|brunei|บรูไน)/i },
    { code: "CAD", re: /(\bcad\b|ดอลลาร์แคนาดา|canadian|แคนาดา)/i },
    { code: "CHF", re: /(\bchf\b|ฟรังก์|franc|สวิตเซอร์แลนด์)/i },
    { code: "DKK", re: /(\bdkk\b|โครนเดนมาร์ก|denmark|เดนมาร์ก|krone)/i },
    { code: "HKD", re: /(\bhkd\b|ดอลลาร์ฮ่องกง|hong\s*kong|ฮ่องกง)/i },
    { code: "IDR", re: /(\bidr\b|รูเปียห์|rupiah|อินโดนีเซีย)/i },
    { code: "ILS", re: /(\bils\b|เชเขล|shekel|อิสราเอล)/i },
    { code: "INR", re: /(\binr\b|รูปีอินเดีย|rupee|อินเดีย)/i },
    { code: "JOD", re: /(\bjod\b|ดีนาร์จอร์แดน|jordan|จอร์แดน)/i },
    { code: "KWD", re: /(\bkwd\b|ดีนาร์คูเวต|kuwait|คูเวต)/i },
    { code: "MMK", re: /(\bmmk\b|จ๊าด|kyat|เมียนมา|พม่า)/i },
    { code: "MOP", re: /(\bmop\b|ปาตากา|pataca|มาเก๊า)/i },
    { code: "MYR", re: /(\bmyr\b|ริงกิต|ringgit|มาเลเซีย)/i },
    { code: "NOK", re: /(\bnok\b|โครนนอร์เวย์|norway|นอร์เวย์|krone)/i },
    { code: "NPR", re: /(\bnpr\b|รูปีเนปาล|nepal|เนปาล)/i },
    { code: "NZD", re: /(\bnzd\b|ดอลลาร์นิวซีแลนด์|new\s*zealand|นิวซีแลนด์)/i },
    { code: "OMR", re: /(\bomr\b|ดีนาร์โอมาน|oman|โอมาน)/i },
    { code: "PHP", re: /(\bphp\b|เปโซ|peso|ฟิลิปปินส์)/i },
    { code: "PKR", re: /(\bpkr\b|รูปีปากี|pakistan|ปากีสถาน)/i },
    { code: "QAR", re: /(\bqar\b|ริยัลกาตาร์|qatar|กาตาร์)/i },
    { code: "RUB", re: /(\brub\b|รูเบิล|ruble|รัสเซีย)/i },
    { code: "SAR", re: /(\bsar\b|ริยัลซาอุ|saudi|ซาอุดีอาระเบีย)/i },
    { code: "SCOT", re: /(\bscot\b|สกอตแลนด์|scotland)/i },
    { code: "SEK", re: /(\bsek\b|โครนสวีเดน|sweden|สวีเดน|krona)/i },
    { code: "SGD", re: /(\bsgd\b|ดอลลาร์สิงคโปร์|singapore|สิงคโปร์)/i },
    { code: "TRY", re: /(\btry\b|ลีราตุรกี|turkey|ตุรกี|lira)/i },
    { code: "TWD", re: /(\btwd\b|ดอลลาร์ไต้หวัน|taiwan|ไต้หวัน)/i },
    { code: "VND", re: /(\bvnd\b|ดอง|dong|เวียดนาม)/i },
    { code: "ZAR", re: /(\bzar\b|แรนด์|rand|แอฟริกาใต้)/i },
  ];
